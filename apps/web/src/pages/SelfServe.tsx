...
const faqs = [
  {
    q: 'What is MCP?',
    a: 'MCP (Model Context Protocol) is an open standard that lets AI assistants connect to external tools and data. ChatGPT and Claude both support it. Skillomatic is an MCP server that gives your AI the ability to interact with your business tools.',
  },
  {
    q: 'Which AI apps work with Skillomatic?',
    a: 'ChatGPT (via Developer Mode) and Claude Desktop both have native MCP support. Other MCP-compatible apps work too. As more AI apps adopt MCP, they\'ll work automatically.',
  },
  {
    q: 'What counts as a "tool call"?',
    a: 'Each action Skillomatic takes on your behalf — checking your calendar, querying a spreadsheet, sending an email — is one tool call. Free tier gets 10/week, Basic is unlimited.',
  },
  {
    q: 'What\'s a scheduled automation?',
    a: 'When you like what the AI did, you can tell it to repeat — "do this every Monday". Free tier allows 3 scheduled automations. Basic and Pro are unlimited.',
  },
  {
    q: 'Is my data secure?',
    a: "We don't store your business data or message content. Your OAuth tokens are encrypted at rest. You can disconnect integrations anytime.",
  },
  {
    q: 'Do I need to be technical to use this?',
    a: "You'll need to enable Developer Mode in ChatGPT or configure Claude Desktop — takes about 2 minutes. After that, you just chat in plain English. No coding required.",
  },
];
